...
def test_match_agent_retry_uses_canonical_query_as_primary_payload(monkeypatch):
    ...
    assert captured["validate_calls"] == [("canonical validation 1", "retry canonical search")]
