...
from app.api.knowledge_staging import router as knowledge_staging_router
app.include_router(knowledge_staging_router, prefix="/api/admin/knowledge-staging", tags=["管理员-staging"])
