...
FIXED_CASES = [
    ...
    ("PPR管", "DN25 热熔连接 给水", None, "K", "塑料管，匹配031001003或相近"),
    ("铸铁排水管", "DN100 承插连接", None, "K", "排水管道"),
    ("洗脸盆", "陶瓷 台上盆", "031003003", "K", "卫生器具"),
    ("坐便器", "陶瓷 虹吸式", None, "K", "卫生器具，同义词→蹲便器或坐便器"),
    ("散热器", "钢制柱型 六柱", "031004001", "K", "采暖设备"),
    ...
    # D 电气
    ("配电箱", "XL-21 落地安装 12回路", "030402011", "D", "成套配电箱"),
    ("电力电缆", "YJV-3×120+2×70 电缆沟敷设", "030409001", "D", "电缆"),
    ("配管", "SC20 暗敷", None, "D", "电线导管"),
    ("灯具", "LED筒灯 嵌入式", None, "D", "照明灯具"),
    ("桥架", "镀锌槽式 200×100", "030408001", "D", "电缆桥架"),
