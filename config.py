...
# 最终置信度标记
CONFIDENCE_GREEN = 90     # 绿色：自动确认
CONFIDENCE_YELLOW = 75    # 黄色：建议人工确认（与前端/API统一）
# 低于75%：红色，需人工处理
